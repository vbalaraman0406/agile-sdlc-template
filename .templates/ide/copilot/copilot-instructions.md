...
## About This Project
This is a {{app_type}} project named "{{project_title}}". The tech stack is {{tech_stack}}.
...
4.  **NO HARDCODED SECRETS**: You are FORBIDDEN from writing code containing API keys, passwords, or tokens. Use environment variables or Vault.
